    ...
    return new Promise((resolve, reject) => {
        db.serialize(() => {
            ...
            const insertProposalData = () => {
                const proposalData = [
                    [1, 'Proposal 1', 'd100001', 'Co-Supervisor A', 'programming, algorithms, null', 'Type A', 'GroupA', 'Embark on an exciting journey into programming and algorithms, contributing to cutting-edge advancements in knowledge and technology.', 'Knowledge about programming', 'Some notes', '2023-12-31', 'BSc', 'CS101'],
                    [2, 'Proposal 2', 'd200002', 'Co-Supervisor C', null, 'Type B', 'GroupB', 'Engage in an innovative project focused on data analysis, exploring new horizons and contributing to the evolving world of data science.', 'Knowledge about data analysis', 'Additional notes', '2024-01-15', 'BSc', 'DEGREE404'],
                    [3, 'Proposal 3', 'd100003', 'Co-Supervisor B', 'design, architecture, development', 'Type C', 'GroupC', 'Explore the intricate realms of software engineering, emphasizing design and architecture, contributing to the evolution of technology and development.', 'Knowledge about software engineering', 'Additional info', '2022-11-20', 'MSc', 'CS101'],
                    [4, 'Proposal 4', 'd100001', 'Co-Supervisor D', 'networks, security, protocols', 'Type D', 'GroupA', 'Contribute to the ever-growing field of cybersecurity, focusing on networks and protocols, and play a vital role in securing the digital future.', 'Knowledge about cybersecurity', 'Important notes', '2023-06-30', 'MSc', 'CS101'],
                    [6, 'Proposal 6', 'd100003', 'Co-Supervisor F', 'medicine, health, research', 'Type F', 'GroupC', 'Join a groundbreaking project in medical research, where your contributions can make a critical impact on the fields of medicine, health, and research.', 'Knowledge about medical research', 'Critical information', '2024-03-05', 'BSc', 'BIO303'],
                    [8, 'Proposal 8', 'd200002', 'Co-Supervisor D', 'economics, finance, markets', 'Type H', 'GroupB', 'Embark on a journey into the dynamic field of financial economics, contributing to cutting-edge research and gaining insights into the world of economics and finance.', 'Knowledge about financial economics', 'Important data', '2023-04-18', 'MSc', 'DEGREE909'],
                    [9, 'Proposal 9', 'd100003', 'Co-Supervisor A', 'linguistics, language, communication', 'Type I', 'GroupC', 'Delve into linguistic studies with a focus on language and communication, contributing to the understanding and evolution of linguistic phenomena.', 'Knowledge about linguistic studies', 'Latest info', '2024-07-22', 'BSc', 'ENG202'],
                    [11, 'Proposal 11', 'd100011', 'Co-Supervisor A', 'web development, programming, design', 'Type A', 'GroupA', 'Embark on an exciting project in web development, programming, and design, contributing to the future of web technologies and digital experiences.', 'Knowledge about web technologies', 'Important notes', '2023-12-31', 'BSc', 'CS101'],
                    [12, 'Proposal 12', 'd200012', 'Co-Supervisor C', 'bioinformatics, data analysis', 'Type B', 'GroupB', 'Explore the vast world of genomic data in this cutting-edge bioinformatics and data analysis project, contributing to advancements in the field of genetics.', 'Knowledge about genomic data', 'Additional notes', '2024-01-15', 'BSc', 'DEGREE404'],
                    [13, 'Proposal 13', 'd100003', 'Co-Supervisor B', 'software development, architecture', 'Type C', 'GroupC', 'Immerse yourself in software engineering, with a focus on development and architecture, contributing to the innovation and evolution of software technologies.', 'Knowledge about software engineering', 'Additional info', '2022-11-20', 'MSc', 'CS101'],
                    [14, 'Proposal 14', 'd100011', 'Co-Supervisor D', 'networks, cybersecurity, protocols', 'Type D', 'GroupA', 'Explore the critical world of network security and cybersecurity, contributing to the development of robust security protocols and safeguarding digital landscapes.', 'Knowledge about network security', 'Important notes', '2023-06-30', 'MSc', 'CS101'],
                    [16, 'Proposal 16', 'd100003', 'Co-Supervisor F', 'medicine, health, research', 'Type F', 'GroupC', 'Contribute to critical medical research, where your efforts can save lives and provide invaluable insights into the realms of medicine, health, and research.', 'Knowledge about medical research', 'Critical information', '2024-03-05', 'BSc', 'BIO303'],
                    [18, 'Proposal 18', 'd200012', 'Co-Supervisor D', 'economics, finance, markets', 'Type H', 'GroupB', 'Embark on a journey into the dynamic field of financial economics, contributing to cutting-edge research and gaining insights into the world of economics and finance.', 'Knowledge about financial economics', 'Important data', '2023-04-18', 'MSc', 'DEGREE909'],
                    [19, 'Proposal 19', 'd200016', 'Co-Supervisor A', 'linguistics, language, communication', 'Type I', 'GroupF', 'Delve into linguistic studies with a focus on language and communication, contributing to the understanding and evolution of linguistic phenomena.', 'Knowledge about linguistic studies', 'Latest info', '2024-07-22', 'BSc', 'ENG202']
                ];
            ...
            const insertArchivedProposalData = () => {
                const archProposalData = [
                    [5, 'Proposal 5', 'd200002', 'Co-Supervisor A', 'statistics, analysis, modeling', 'Type E', 'GroupB', 'Engage in statistical analysis and modeling, contributing to advancements in data-driven decision-making and statistical methodologies.', 'Knowledge about statistical analysis', 'New notes', '2022-09-10', 'BSc', 'DEGREE404', "Expired", null],
                    [7, 'Proposal 7', 'd100001', 'Co-Supervisor C', 'AI, machine learning, robotics', 'Type G', 'GroupA', 'Explore the realms of AI, machine learning, and robotics, contributing to cutting-edge technologies and pushing the boundaries of artificial intelligence.', 'Knowledge about artificial intelligence', 'Urgent notes', '2022-12-01', 'MSc', 'CS101', "Archived", "s200009"],
                    [10, 'Proposal 10', 'd100001', 'Co-Supervisor E', 'environment, sustainability, climate', 'Type A', 'GroupA', 'Contribute to environmental sustainability and climate studies, making a positive impact on the planet through advanced knowledge and research.', 'Knowledge about environmental science', 'Updated notes', '2022-07-15', 'MSc', 'BIO303', "Archived","s200008"],
                    [15, 'Proposal 15', 'd200012', 'Co-Supervisor A', 'statistics, machine learning, modeling', 'Type E', 'GroupB', 'Engage in statistical analysis and modeling, contributing to advancements in data-driven decision-making and statistical methodologies.', 'Knowledge about statistical analysis', 'New notes', '2022-09-10', 'BSc', 'DEGREE404', "Expired", null],
                    [17, 'Proposal 17', 'd100011', 'Co-Supervisor C', 'AI, machine learning, robotics', 'Type G', 'GroupA', 'Explore the realms of AI, machine learning, and robotics, contributing to cutting-edge technologies and pushing the boundaries of artificial intelligence.', 'Knowledge about artificial intelligence', 'Urgent notes', '2022-12-01', 'MSc', 'CS101', "Expired", null],
                    [20, 'Proposal 20', 'd100011', 'Co-Supervisor E', 'environment, sustainability, climate', 'Type J', 'GroupA', 'Contribute to environmental sustainability and climate studies, making a positive impact on the planet through advanced knowledge and research.', 'Knowledge about environmental science', 'Updated notes', '2022-07-15', 'MSc', 'BIO303', "Expired", null],
                    // Add more data as needed
                ];
