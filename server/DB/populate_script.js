        ...
        db.serialize(() => {
            ...
            const insertProposalData = () => {
                const proposalData = [
                    ...
                    [4, 'Safeguarding the Digital Future: Cybersecurity Focus', 'd100001', 'd200002 esterna@notpoli.com', 'networks, security, protocols', 'Abroad', 'GroupA GroupB', 'Contribute to the ever-growing field of cybersecurity, focusing on networks and protocols, and play a vital role in securing the digital future.', 'Knowledge about cybersecurity', 'Important notes', '2023-06-30', 'MSc', 'CS101'],
