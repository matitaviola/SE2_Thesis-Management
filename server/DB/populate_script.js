    ...
    return new Promise((resolve, reject) => {
        db.serialize(() => {
            ...
            const insertProposalData = () => {
                const proposalData = [
                    [1, 'Exploring Advanced Programming Paradigms', 'd100001', null, 'programming, algorithms, null', 'Company', 'GroupA', 'Embark on an exciting journey into programming and algorithms, contributing to cutting-edge advancements in knowledge and technology.', 'Knowledge about programming', 'Some notes', '2023-12-31', 'BSc', 'ENG202 BIO303 CS101'],
                    [2, 'Unveiling New Horizons in Data Analysis', 'd200002', 'd100001 externo@notpoli.com', null, 'Research', 'GroupB GroupA', 'Engage in an innovative project focused on data analysis, exploring new horizons and contributing to the evolving world of data science.', 'Knowledge about data analysis', 'Additional notes', '2024-01-15', 'BSc', 'DEGREE404'],
                    [3, 'Architectural Innovation in Software Development', 'd100003', null, 'design, architecture, development', 'Development', 'GroupC', 'Explore the intricate realms of software engineering, emphasizing design and architecture, contributing to the evolution of technology and development.', 'Knowledge about software engineering', 'Additional info', '2022-11-20', 'MSc', 'CS101 ENG202 BIO303'],
                    [4, 'Safeguarding the Digital Future: Cybersecurity Focus', 'd100001', 'd200002 externo@notpoli.com', 'networks, security, protocols', 'Abroad', 'GroupA GroupB', 'Contribute to the ever-growing field of cybersecurity, focusing on networks and protocols, and play a vital role in securing the digital future.', 'Knowledge about cybersecurity', 'Important notes', '2023-06-30', 'MSc', 'CS101'],
            ...
            const insertArchivedProposalData = () => {
                const archProposalData = [
                    ...
                    [10, 'Advancing Environmental Sustainability and Climate Studies', 'd100001', 'd100003 externo@notpoli.com', 'environment, sustainability, climate', 'Company', 'GroupA GroupC', 'Contribute to environmental sustainability and climate studies, making a positive impact on the planet through advanced knowledge and research.', 'Knowledge about environmental science', 'Updated notes', '2022-07-15', 'MSc', 'BIO303', "Archived","s200008"],
