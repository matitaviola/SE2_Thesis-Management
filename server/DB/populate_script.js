    ...
    return new Promise((resolve, reject) => {
        db.serialize(() => {
            ...
            const insertStudentData = () => {
                ...
                const studentsData = [
                    ['s000001', 'Moss', 'Elmo', 'Male', 'American', 'mta_studenti.polito@libero.it', 'CE001', 2021],
                    ['s000002', 'Woods', 'Brian', 'Male', 'Scottish', 'mtr_studenti.polito@libero.it', 'CE001', 2022],
            ...
            const insertCareerData = () => {
                const careerData = [
                    ['s000001', 'COURSE101', 'Introduction to Programming', 5, '30', '2022-05-15'],
                    ['s000001', 'COURSE202', 'Data Structures', 6, '27', '2023-01-20'],
                    ['s200009', 'COURSE303', 'Advanced Biology', 7, '21', '2021-11-30'],
                    ['s000001', 'COURSE404', 'Algorithms', 6, '30L', '2022-08-25'],
                    ['s200007', 'COURSE505', 'Organic Chemistry', 7, '18', '2023-12-10'],
                    ['s000001', 'COURSE606', 'Artificial Intelligence', 6, '23', '2021-06-05'],
                    ['s200002', 'COURSE707', 'Literary Theory', 5, '29', '2023-09-28'],
                    ['s200008', 'COURSE808', 'Genetics', 7, '25', '2022-04-17'],
                    ['s000001', 'COURSE909', 'Database Management', 6, '30', '2021-10-22'],
                    ['s000001', 'COURSE1010', 'Electrical Engineering', 7, '30L', '2023-02-14'],
                    ["s000001", 'COURSE101', 'Introduction to Programming', 5, '30', '2022-05-15'],
                    ["s000002", 'COURSE101', 'Introduction to Programming', 5, '30', '2022-05-15'],
                    ["s000002", 'COURSE202', 'Data Structures', 6, '27', '2023-01-20'],
                    ["s200007", 'COURSE303', 'Advanced Biology', 7, '29', '2021-11-30'],
                    ["s000002", 'COURSE404', 'Algorithms', 6, '28', '2022-08-25'],
                    ["s200006", 'COURSE505', 'Organic Chemistry', 7, '30', '2023-12-10'],
                    ["s000002", 'COURSE606', 'Artificial Intelligence', 6, '27', '2021-06-05'],
                    ["s200007", 'COURSE707', 'Literary Theory', 5, '29', '2023-09-28'],
                    ["s200009", 'COURSE808', 'Genetics', 7, '23', '2022-04-17'],
                    ["s000002", 'COURSE909', 'Database Management', 6, '24', '2021-10-22'],
                    ["s200009", 'COURSE1010', 'Electrical Engineering', 7, '30L', '2023-02-14'],
                    ['s000002', 'COURSE111', 'Web Development', 5, '28', '2022-06-10'],
                    ['s000001', 'COURSE222', 'Bioinformatics', 6, '25', '2023-02-18'],
                    ['s200019', 'COURSE333', 'Ecology', 7, '29', '2021-12-01'],
                    ['s000002', 'COURSE444', 'Machine Learning', 6, '30L', '2022-09-15'],
                    ...
                    ['s000002', 'COURSE999', 'Database Systems', 6, '28', '2021-11-02'],
                    ['s000001', 'COURSE1010', 'Electronic Circuits', 7, '30L', '2023-03-20'],
                    // Add more data as needed
                ];
            ...
            const insertProposalData = () => {
                const proposalData = [
                    [1, 'Exploring Advanced Programming Paradigms', 'd100000', null, 'programming, algorithms, null', 'Company', 'EEIGroup', 'Embark on an exciting journey into programming and algorithms, contributing to cutting-edge advancements in knowledge and technology.', 'Knowledge about programming', 'Some notes', '2024-12-31', 'MSc', 'ENG202 BIO303 CE001','Active'],
                    [2, 'Unveiling New Horizons in Data Analysis', 'd200002', 'd100000 esterna@notpoli.com', 'mathematics, data silos', 'Research', 'GroupB EEIGroup', 'Engage in an innovative project focused on data analysis, exploring new horizons and contributing to the evolving world of data science.', 'Knowledge about data analysis', 'Additional notes', '2024-01-15', 'BSc', 'DEGREE404','Active'],
                    ...
                    [4, 'Safeguarding the Digital Future: Cybersecurity Focus', 'd100000', 'd200002 esterna@notpoli.com', 'networks, security, protocols', 'Abroad', 'EEIGroup GroupB', 'Contribute to the ever-growing field of cybersecurity, focusing on networks and protocols, and play a vital role in securing the digital future.', 'Knowledge about cybersecurity', 'Important notes', '2024-06-30', 'MSc', 'CE001','Active'],
                    ...
                    [19, 'Linguistic Phenomena: Evolution through Language and Communication In Electronic Devices', 'd100000', 'd200002', 'linguistics, language, communication', 'Company', 'EEIGroup GroupB', 'Delve into linguistic studies with a focus on language and communication, contributing to the understanding and evolution of linguistic phenomena.', 'Knowledge about linguistic studies', 'Latest info', '2024-07-22', 'MSc', 'CE001 ENG202','Active'],
                    //archived, will be deleted, used because the ID is self-increasing and might cause issues otherwise
                    [5, 'Linguistic Phenomena: Evolution through Language-Advancing Data-Driven Decision-Making through Statistical Analysis and Communication', 'd200002', 'd100000', 'statistics, analysis, modeling', 'Company', 'GroupB EEIGroup', 'Engage in statistical analysis and modeling, contributing to advancements in data-driven decision-making and statistical methodologies.', 'Knowledge about statistical analysis', 'New notes', '2022-09-10', 'BSc', 'DEGREE404','Active'],
                    [7, 'Pushing Boundaries in AI, Machine Learning, and Robotics', 'd100000', null, 'AI, machine learning, robotics', 'Development', 'EEIGroup', 'Explore the realms of AI, machine learning, and robotics, contributing to cutting-edge technologies and pushing the boundaries of artificial intelligence.', 'Knowledge about artificial intelligence', 'Urgent notes', '2022-12-01', 'MSc', 'CE001','Active'],
                    [10, 'Advancing Environmental Sustainability and Climate Studies', 'd100000', 'd100003 esterna@notpoli.com', 'environment, sustainability, climate', 'Company', 'EEIGroup GroupC', 'Contribute to environmental sustainability and climate studies, making a positive impact on the planet through advanced knowledge and research.', 'Knowledge about environmental science', 'Updated notes', '2022-07-15', 'MSc', 'BIO303 CE001','Active'],
                ...
                const stmt = db.prepare('INSERT INTO PROPOSAL (Id, Title, Supervisor, Co_supervisor, Keywords, Type, Groups, Description, Req_knowledge, Notes, Expiration, Level, CdS, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
            ...
            const insertArchivedProposalData = () => {
                const archProposalData = [
                    [5, 'Linguistic Phenomena: Evolution through Language-Advancing Data-Driven Decision-Making through Statistical Analysis and Communication', 'd200002', 'd100000', 'statistics, analysis, modeling', 'Company', 'GroupB EEIGroup', 'Engage in statistical analysis and modeling, contributing to advancements in data-driven decision-making and statistical methodologies.', 'Knowledge about statistical analysis', 'New notes', '2022-09-10', 'BSc', 'DEGREE404', "Expired", null],
                    [7, 'Pushing Boundaries in AI, Machine Learning, and Robotics', 'd100000', 'd100003 esterna@notpoli.com', 'AI, machine learning, robotics', 'Development', 'EEIGroup GroupC', 'Explore the realms of AI, machine learning, and robotics, contributing to cutting-edge technologies and pushing the boundaries of artificial intelligence.', 'Knowledge about artificial intelligence', 'Urgent notes', '2022-12-01', 'MSc', 'CE001', "Archived", "s200009"],
            ...
            const insertApplicationData = () => {
                const applicationData = [
                    [1,'s200000', 1, null, 'Exploring Advanced Programming Paradigms', 'Pending'],
                    [2,'s200000', 2, null, 'Unveiling New Horizons in Data Analysis', 'Rejected'],
                    [3,'s200000', null, 7, 'Pushing Boundaries in AI, Machine Learning, and Robotics', 'Cancelled'],
                    [4,'s200001', 3, null, 'Architectural Innovation in Software Development', 'Pending'],
                    [5,'s200002', 2, null, 'Unveiling New Horizons in Data Analysis', 'Rejected'],
                    [6,'s200003', 3, null, 'Architectural Innovation in Software Development', 'Pending'],
                    [7,'s200004', 4, null, 'Safeguarding the Digital Future: Cybersecurity Focus', 'Rejected'],
                    [8,'s200005', 5, null, 'Linguistic Phenomena: Evolution through Language-Advancing Data-Driven Decision-Making through Statistical Analysis and Communication', 'Pending'],
                    [9,'s200006', 6, null, 'Pioneering Groundbreaking Medical Research Projects', 'Rejected'],
                    [10,'s200007', null, 7,  'Pushing Boundaries in AI, Machine Learning, and Robotics', 'Cancelled'],
                    [11,'s200010', 11, null, 'Innovating Web Technologies and Digital Experiences', 'Pending'],
                    [12,'s200010', 8, null, 'Navigating Financial Economics Frontiers with Insight', 'Rejected'],
                    [13,'s200011', 13, null, 'Innovations in Software Engineering and Architecture', 'Pending'],
                    [14,'s200012', 12, null, 'Genomic Data Exploration: Advancements in Genetics', 'Rejected'],
                    [15,'s200013', 13, null, 'Innovations in Software Engineering and Architecture', 'Pending'],
                    [16,'s200014', 14, null, 'Defending Digital Landscapes: Network Security Focus', 'Pending'],
                    [17,'s200015', 15, null, 'Elevating Data-Driven Decision-Making through Statistical Analysis', 'Pending'],
                    [18,'s200016', 4, null, 'Safeguarding the Digital Future: Cybersecurity Focus', 'Rejected'],
                    [19,'s200017', 17, null, 'Breaking Ground in AI, Machine Learning, and Robotics', 'Pending'],
                    [20,'s200018', 18, null, 'Unveiling Financial Frontiers: Insights in Economics', 'Pending'],
                    [21,'s200009', null, 7, 'Pushing Boundaries in AI, Machine Learning, and Robotics', 'Accepted'],
                    [22,'s200008', null, 10, 'Advancing Environmental Sustainability and Climate Studies', 'Accepted'],
                    [23,'s000001', 1, null, 'Exploring Advanced Programming Paradigms', 'Pending'],
                    [24,'s000002', 3, null, 'Architectural Innovation in Software Development', 'Pending'],
                    // Add more data as needed
                ];

                const stmt = db.prepare('INSERT INTO APPLICATION (Id,Student_ID, Proposal_ID, Archived_Proposal_ID, Proposal, Status) VALUES (?,?, ?, ?, ?, ?)');
