...
const { getActiveProposalsByProfessor, archiveProposal, getAvailableProposals, addProposal, deleteProposal, getProposalById, getArchivedProposalById } = require('../DB/proposals-dao');
